...
- Vercel production builds never run database migrations. Migrations require a separate, explicitly approved `pnpm production:migrate` command after preflight and backup verification.
