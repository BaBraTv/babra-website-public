...
RC18 completed on branch `codex/production-readiness`. RC20 later removed unreferenced demo media. No merge to `main` and no production deployment were performed.
...
- Products page: lists only the three approved 500 ml lotion products.
...
RC20 removed unreferenced demo/unverified files from these older public folders after confirming the active site uses `public/media/` instead:
...
The verified official logo and bottle media remain available through `public/media/`.
